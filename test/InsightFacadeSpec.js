...
describe("InsightFacadeSpec", function () {
    ...
    var contentEmpty = "";
    var contentRooms = "";
    fs.readFile(__dirname + "/courses.zip", { encoding: "base64" }, function (err, data) {
        if (err) {
            throw err;
        }
        else {
    ...
    fs.readFile(__dirname + "/empty.zip", { encoding: "base64" }, function (err, data) {
        if (err) {
            throw err;
        }
        else {
    ...
    fs.readFile(__dirname + "/rooms.zip", { encoding: "base64" }, function (err, data) {
        if (err) {
            throw err;
        }
        else {
    ...
    it('Test for an empty courses.', function () {
        return insightFacade.addDataset("courses", contentEmpty).then(function (response) {
            chai_1.expect.fail();
    ...
    it('Test for an empty rooms.', function () {
        return insightFacade.addDataset("rooms", contentEmpty).then(function (response) {
            chai_1.expect.fail();
        }).catch(function (response) {
            chai_1.expect(response.code).to.equal(400);
        });
    ...
    it('Test for adding the rooms file when there was no file', function () {
        return insightFacade.addDataset("rooms", contentRooms).then(function (response) {
    ...
    it('Test for adding a file when there was no file.', function () {
        return insightFacade.addDataset("courses", content).then(function (response) {
            chai_1.expect(response.code).to.equal(204);
        }).catch(function (response) {
            chai_1.expect.fail();
        });
    ...
    it('4', function () {
        return insightFacade.addDataset("invalidJSON", "asdfasdfa").then(function (response) {
            chai_1.expect.fail();
        }).catch(function (response) {
            chai_1.expect(response.code).to.equal(400);
        });
    ...
    it('Fireball0: Should be able to find all courses in a dept with a partial name.', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "AND": [
                    {
    ...
    it('Fireball1: Should be able to find all courses in a dept with a partial name.', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "AND": [
                    {
    ...
    it('Fireball2: Should be able to find all courses in a dept with a partial name.', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "AND": [
                    {
    ...
    it('Firefly0: Should be able to find all instructurs in a dept with a partial name.', function () {
    ...
    it('Firefly1: Should be able to find all instructurs in a dept with a partial name.', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "AND": [
                    {
    ...
    it('Firefly2: Should be able to find all instructurs in a dept with a partial name.', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "AND": [
                    {
    ...
    it('Test should fail when the transformations format is wrong 0', function () {
        return insightFacade.performQuery({
            "WHERE": {},
            "OPTIONS": {
                "COLUMNS": [
    ...
    it('Test should fail when the transformations format is wrong 1', function () {
        return insightFacade.performQuery({
            "WHERE": {},
            "OPTIONS": {
                "COLUMNS": [
    ...
    it('Test should fail when the transformation format is wrong 2', function () {
        return insightFacade.performQuery({
            "WHERE": {},
            "OPTIONS": {
                "COLUMNS": [
    ...
    it('Test should fail when the transformation format is wrong 3', function () {
        return insightFacade.performQuery({
            "WHERE": {},
            "OPTIONS": {
                "COLUMNS": [
    ...
    it('Test should fail when the transformation format is wrong 4', function () {
        return insightFacade.performQuery({
            "WHERE": {},
            "OPTIONS": {
                "COLUMNS": [
    ...
    it('Test should fail when the transformation format is wrong 5', function () {
        return insightFacade.performQuery({
            "WHERE": {
                "GT": {
                    "rooms_seats": 10
    ...
    it('Test should fail when the transformation format is wrong 6', function () {
        return insightFacade.performQuery({
            "WHERE": {},
            "OPTIONS": {
                "COLUMNS": [
    ...
    it('Test should fail when the transformation format is wrong 7', function () {
        return insightFacade.performQuery({
            "WHERE": {},
            "OPTIONS": {
                "COLUMNS": [
    ...
    it('Test should fail when the transformation format is wrong 8', function () {
        return insightFacade.performQuery({
            "WHERE": {},
            "OPTIONS": {
                "COLUMNS": [
    ...
    it('Test should fail when the transformation format is wrong 9', function () {
        return insightFacade.performQuery({
            "WHERE": {},
            "OPTIONS": {
                "COLUMNS": [
    ...
    it('Test should fail when the transformation format is wrong 10', function () {
        return insightFacade.performQuery({
            "WHERE": {},
            "OPTIONS": {
                "COLUMNS": [
    ...
    it('Test should fail when the transformations format is wrong 11', function () {
        return insightFacade.performQuery({
            "WHERE": {},
            "OPTIONS": {
                "COLUMNS": [
    ...
    it('At the end of test, remove rooms', function () {
        return insightFacade.removeDataset("rooms").then(function (response) {
            chai_1.expect(response.code).to.equal(204);
        }).catch(function (response) {
            chai_1.expect.fail();
        });
